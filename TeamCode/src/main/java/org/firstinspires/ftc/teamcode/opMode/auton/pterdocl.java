...
public class pterdocl extends LinearOpMode {
    ...
    public static double preSplineVersY = 55.0;
    public static double preSplineVersX = 2;
    ...
    Vector2d preSplineVers = new Vector2d(preSplineX, preSplineY);
    public static double preSplineVersAng = 45;
