...
import org.firstinspires.ftc.teamcode.drive.locolization.SwerveLocalizer;
...
@Config
public class TestingTwoWheelLocalizer extends TwoTrackingWheelLocalizer implements SwerveLocalizer {
    ...
    public TestingTwoWheelLocalizer(TestingBrainSTEMRobot robot) {
