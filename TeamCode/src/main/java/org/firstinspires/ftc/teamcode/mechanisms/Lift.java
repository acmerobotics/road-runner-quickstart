...
public class Lift {
    ...
    final double LIFT_SCORING_IN_HIGH_BASKET = 663 * LIFT_TICKS_PER_MM;

    public static double LIFT_SLIGHTLY_OUT = 100 * LIFT_TICKS_PER_MM;
    public static double LIFT_COLLECT = 200 * LIFT_TICKS_PER_MM;
