...
public class Auton_Red_Field extends LinearOpMode {
    ...
    Trajectory traj0, trajA1, trajA2, trajA3, trajA4, trajA5, trajA6;
...
switch (ringsDetected) {
    ...
    case "Quad":
        ...
        trajC2 = drive.trajectoryBuilder(trajC1.end(), true)
                .lineToSplineHeading(new Pose2d(56, -48, Math.toRadians(90)))
                .build();

        trajC3 = drive.trajectoryBuilder(trajC2.end())
                .lineToSplineHeading(new Pose2d(-25, -48, Math.toRadians(0)))
                .build();
