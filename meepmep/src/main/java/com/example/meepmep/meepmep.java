...
public class meepmep {
    public static void main(String[] args) {
        ...
        BlueHumanSide.runAction(BlueHumanSide.getDrive().actionBuilder(new Pose2d(-15, 63, Math.toRadians(270)))
                ...
                .waitSeconds(2)
                .strafeToLinearHeading(new Vector2d(-4,36), Math.toRadians(270))
                .waitSeconds(2)
                ...
                .strafeTo(new Vector2d(-4,36))
                .waitSeconds(2)
                .strafeToLinearHeading(new Vector2d(-44,52), Math.toRadians(270))
                .build());
        ...
        RedHumanSide.runAction(RedHumanSide.getDrive().actionBuilder(new Pose2d(15, -63, Math.toRadians(90)))
                ...
                .strafeToLinearHeading(new Vector2d(56,-54), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(56,-12), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(61,-12), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(61,-54), Math.toRadians(90))
                ...
                .strafeTo(new Vector2d(4,-36))
                .waitSeconds(2)
                .strafeToLinearHeading(new Vector2d(44,-52), Math.toRadians(90))
                .build());
