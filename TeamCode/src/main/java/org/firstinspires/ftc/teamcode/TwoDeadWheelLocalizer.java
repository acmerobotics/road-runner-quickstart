...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 29.820756719671483; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -51.961001774940286; // x position of the perpendicular encoder (in tick units)
    }
