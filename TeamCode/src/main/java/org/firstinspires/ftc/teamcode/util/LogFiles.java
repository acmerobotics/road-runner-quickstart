...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double tankAxialP = SampleMecanumDrive.SampleTankDrive.AXIAL_PID.kP;
        public double tankAxialI = SampleMecanumDrive.SampleTankDrive.AXIAL_PID.kI;
        public double tankAxialD = SampleMecanumDrive.SampleTankDrive.AXIAL_PID.kD;
        public double tankCrossTrackP = SampleMecanumDrive.SampleTankDrive.CROSS_TRACK_PID.kP;
        public double tankCrossTrackI = SampleMecanumDrive.SampleTankDrive.CROSS_TRACK_PID.kI;
        public double tankCrossTrackD = SampleMecanumDrive.SampleTankDrive.CROSS_TRACK_PID.kD;
        public double tankHeadingP = SampleMecanumDrive.SampleTankDrive.HEADING_PID.kP;
        public double tankHeadingI = SampleMecanumDrive.SampleTankDrive.HEADING_PID.kI;
        public double tankHeadingD = SampleMecanumDrive.SampleTankDrive.HEADING_PID.kD;
