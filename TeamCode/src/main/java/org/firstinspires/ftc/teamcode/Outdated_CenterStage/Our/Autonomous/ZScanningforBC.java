...
@Autonomous(name="ScanningforBC", group="Linear OpMode")

@Disabled
public class ZScanningforBC extends LinearOpMode {
    ...
    */
    ...
    private void TurnRightandMove () {
        ...
        if(Gyro_Degrees<-30 && DistanceSensor < 75) {
            ...
            //if middle spike
        } else if (Gyro_Degrees>-20 && Gyro_Degrees <20 && DistanceSensor < 5 ) {
            ...
            //if right spike
        } else if (Gyro_Degrees>30 && DistanceSensor < 5 ) {
