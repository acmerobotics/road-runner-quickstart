...
@Autonomous(name="BlueBack", group="AUTOOOO")
public final class BlueBack extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            robot.drivebase.drive.setDrivePowers(robot.drivebase.stickOnly(0, -.65, 0));
            sleep(3000);
