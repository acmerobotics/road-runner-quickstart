...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2.718759451484958; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1.180211499060051; // x position of the perpendicular encoder (in tick units)
    }
