        ...
        RoadRunnerBotEntity myBotBlue = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        ...
                        drive.trajectorySequenceBuilder(startPos)
                                        ...
                                        .splineToLinearHeading(new Pose2d(repositionX + distanceForwards, reposistionY),
                                                        Math.toRadians(
                                                                        0))
                                        // .lineToLinearHeading(new Pose2d(repositionX + distanceForwards,
                                        // reposistionY,Math.toRadians(0)))
