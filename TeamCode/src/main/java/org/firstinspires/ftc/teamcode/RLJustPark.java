...
public class RLJustPark extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (!isStopRequested() && !opModeIsActive()) {
            signal = extras.telemetryTfod(ExtraOpModeFunctions.AutoStart.RL);
        ...
        switch(signal)
        {
            case LEFT:
                ...
                purplePixelDropoff = new Pose2d(18,-1,Math.toRadians(20));
        ...
        park = new Pose2d(2,55,Math.toRadians(0));
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeToLinearHeading(new Vector2d(30,-5), Math.toRadians(90))
                        .build());
