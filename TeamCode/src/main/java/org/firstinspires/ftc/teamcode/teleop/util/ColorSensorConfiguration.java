...
public class ColorSensorConfiguration extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 5); // 5mm or closer requirement
        ...
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 5); // 5mm or closer requirement
