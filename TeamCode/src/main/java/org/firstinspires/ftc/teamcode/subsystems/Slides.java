...
public class Slides extends Mechanism {
    ...
    private static final double PIVOT_ENABLED_THRESHOLD = 30;
    ...
    public void loop(AIMPad aimpad, AIMPad aimpad2) {
        ...
        isPivotEnabled = slidesBase.getCurrentExtension() < PIVOT_ENABLED_THRESHOLD;
    }

    @Override
    public void telemetry(Telemetry telemetry) {
        telemetry.addData("Current Position: ", slidesBase.getCurrentPosition());
        telemetry.addData("Current Extension", slidesBase.getCurrentExtension());
