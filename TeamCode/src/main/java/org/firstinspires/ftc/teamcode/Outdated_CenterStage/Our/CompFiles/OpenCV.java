...
public class OpenCV implements VisionProcessor {
    ...
    Scalar lowVRedlow = new Scalar(0,125,125);
    Scalar lowVRedHigh = new Scalar(10,255,255);

    Scalar upperVRedlow = new Scalar(165,125,125);
    Scalar upperVRedHigh = new Scalar(180,255,255);
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        double middlePercent = (Core.sumElems(DetectMat.submat(Middle)).val[0]/255)/Middle.area();
        double rightPercent = (Core.sumElems(DetectMat.submat(Right)).val[0]/255)/Right.area();


        Scalar green =new Scalar(250,0,0);
        Scalar red =new Scalar(0,250,0);
