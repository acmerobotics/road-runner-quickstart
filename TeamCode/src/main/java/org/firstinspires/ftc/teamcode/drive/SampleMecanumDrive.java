...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(DriveConstants.withDW? 3 : 8, 0, 0);
    public static double LATERAL_MULTIPLIER = DriveConstants.withDW? 1.37 : 1.18;
